<%-- 
    Document   : updateGoal
    Created on : 7 Jul, 2024, 3:19:50 PM
    ...
    <div class="container">
        ...
        <% if ("true".equals(request.getParameter("error"))) { %>
            <div class="alert alert-danger">
                <strong>Error!</strong> Failed to update goal.
            </div>
        <% } %>
        
        <form action="updateGoal" method="post">
            <div class="form-group">
                <label for="goalId">Goal ID:</label>
                <input type="text" id="goalId" name="goalId" required>
            </div>
            <div class="form-group">
