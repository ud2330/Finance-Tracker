...
<body>
    <div class="container-fluid">
        ...
        <div class="form-container">
            ...
            <!-- Success Message -->
            <div class="alert alert-success <% if ("Transaction updated successfully".equals(request.getParameter("success"))) { %> show <% } %>">
                <strong>Success!</strong> <%= request.getParameter("success") %>
            </div>
            
            <!-- Error Message -->
            <div class="alert alert-danger <% if ("Failed to update transaction.".equals(request.getAttribute("errorMessage"))) { %> show <% } %>">
