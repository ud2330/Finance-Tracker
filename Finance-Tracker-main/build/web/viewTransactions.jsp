...
<body>
    <div class="container-fluid">
        ...
        <div class="transactions-container animation">
            <h2 class="text-center">View Transactions</h2>
            <form action="viewTransaction" method="get">
                <div class="form-group">
                    <label for="id">Transaction ID (leave blank to view all):</label>
                    <input type="text" id="id" name="id" class="form-control" placeholder="Enter transaction ID">
                </div>
                <button type="submit" class="btn btn-primary btn-block">View Transaction</button>
            </form>
        </div>
    </div>
</body>
